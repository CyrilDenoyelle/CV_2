...
setInterval(function(){
	...
	vid[0].currentTime-=((vid[0].currentTime-scrollRatio)/10)>=0.05||((vid[0].currentTime-scrollRatio)/10)<=-0.05?(vid[0].currentTime-scrollRatio)/20:0;//valeur negative pour permettre la lecture a l'enver de la video quand on scroll vers le haut
}, 100);
